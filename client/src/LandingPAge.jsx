    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-6 py-20">
        ...
        <div className="absolute inset-0 -z-10">
          <div
            className={`absolute inset-0 ${
              isDark
                ? "bg-gradient-to-br from-[#0A0F1F] via-[#0F1A3A] to-[#0A111F]"
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              End-to-end encrypted. Zero-knowledge architecture. Revocable
              access tokens.
            ...
            <div className="mt-8 flex items-center gap-8 hidden lg:flex">
              <div className="flex -space-x-3">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className="w-12 h-12 rounded-full bg-gradient-to-br from-orange-400 to-red-600 border-4 border-white shadow-lg"
                  />
                ))}
              </div>
              <div>
          ...
          >
            ...
            >
              ...
              <motion.div
                ...
                className={`absolute -top-10 left-1/2 -translate-x-1/2 px-8 py-4 rounded-2xl ${
                  isDark
                    ? "bg-gradient-to-r from-orange-600 to-red-600"
                    : "bg-gradient-to-r from-orange-500 to-red-500"
                } text-white font-bold shadow-2xl whitespace-nowrap`}
              >
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                <div
                  className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${item.color} p-4 mb-6`}
                >
      ...
      <section className="py-20 px-6 bg-gradient-to-t from-orange-600/10 to-transparent">
        ...
        >
          ...
          >
            Join thousands who stopped sharing files and started{" "}
            <span className="text-orange-500 font-bold">vaulting</span> them.
          </p>
